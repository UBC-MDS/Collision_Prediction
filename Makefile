...
data/processed/train.csv : data/raw/NCDB_2017.csv
	python src/clean_split_data.py --input=data/raw/NCDB_2017.csv --output=data/processed/
data/processed/test.csv : data/raw/NCDB_2017.csv
	python src/clean_split_data.py --input=data/raw/NCDB_2017.csv --output=data/processed/

# run eda report
results/Distribution_of_no_fatality.png : data/processed/train.csv
	python src/eda.py --train=data/processed/train.csv --out_dir=results/
results/Distribution_of_fatality.png : data/processed/train.csv
	python src/eda.py --train=data/processed/train.csv --out_dir=results/

# create and tune model
results/lr_model.rds : data/processed/train.csv
	python src/model.py --input=data/processed/train.csv --output=results/
results/CV_results.csv : data/processed/train.csv
	python src/model.py --input=data/processed/train.csv --output=results/

# feature selection
results/final_model.rds : data/processed/train.csv results/lr_model.rds
	python src/feature_selection.py --input=data/processed/train.csv --output=results/
results/final_training_scores.csv : data/processed/train.csv results/lr_model.rds
	python src/feature_selection.py --input=data/processed/train.csv --output=results/

# score test data
results/final_scores.csv : data/processed/test.csv results/final_model.rds
	python src/score.py --input=data/processed/ --output=results/
results/test_confusion_matrix.csv : data/processed/test.csv results/final_model.rds
	python src/score.py --input=data/processed/ --output=results/
